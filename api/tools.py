...
TOOLS = [
    ...
    },
    {
        ...
        "function": {
            "name": "route_to_agent",
            "description": (
                "Act on the user's machine AND reach the outside world. "
                "Your hands and eyes are there; this is how you use them. "
                "Call this when the user asks for anything a body does — "
                "running commands, reading or editing files on their "
                "computer, listing wi-fi, checking services, touching "
                "hardware, installing things, inspecting configs — OR "
                "anything that needs the live web: today's news, current "
                "weather, a URL, a lookup of something post-knowledge-"
                "cutoff. The body has a browser; you do not. If the lake "
                "doesn't already know and the world would, reach. What "
                "comes back is what you just did and saw; narrate to the "
                "user in first person ('one sec, checking' → then call "
                ...
                "properties": {
                    "message": {
                        ...
                        "description": (
                            ...
                            "'see what the top world news stories are today' — good. "
